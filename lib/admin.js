    ...
    var a = layui.jquery
      ...
      , F = {
        ...
        sendAuthCode: function(e) {
            ...
            var i, t = e.seconds, l = a(e.elem), n = function(a) {
                t--,
                t < 0 ? (l.removeClass(f).html("获取验证码"),
                t = e.seconds,
                clearInterval(i)) : l.addClass(f).html(t + "秒后重获"),
      ...
      , P = F.events = {
        ...
        closeOtherTabs: function(e) {
            ...
            a(h).find("." + b + ":gt(0)").remove(),
            a(z).eq(0).trigger("click")) : (a(z).each(function(e, t) {
                e && e != F.tabsPage.index && (a(t).addClass(i),
                F.tabsBody(e).addClass(i))
            }),
            a("." + i).remove())
        },
